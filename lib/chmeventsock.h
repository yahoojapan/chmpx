...
class ChmEventSock : public ChmEventBase
{
	...
	protected:
		...
		bool PxComReceiveStatusReq(PCOMHEAD pComHead, const PXCOM_ALL* pComAll, PCOMPKT* ppResComPkt);
		...
		bool PxComReceiveMergeSuspendGet(PCOMHEAD pComHead, const PXCOM_ALL* pComAll, PCOMPKT* ppResComPkt);
		...
		bool PxCltReceiveJoinNotify(const PCOMHEAD pComHead, const PXCLT_ALL* pComAll);
		...
		bool PxComReceiveVersionReq(int sock, PCOMHEAD pComHead, const PXCOM_ALL* pComAll);										// 1.0.71 or later
